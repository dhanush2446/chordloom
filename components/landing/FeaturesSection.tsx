...
const features = [
  ...
  { title: '10 Timbres', desc: 'From warm theremin to brass, strings, voice, and organ — each timbre crafted with precise harmonic profiles for authentic character.', icon: 3 },
